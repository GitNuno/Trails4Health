...
namespace Trails4Health.Controllers
{
    public class RespostasAvaliacaoController : Controller
    {
        ...
        {
            var applicationDbContext = _context.RespostasAvaliacao.Include(r => r.Guia).Include(r => r.Questao).Include(r => r.Turista);
        ...
        public async Task<IActionResult> Create([Bind("RespostaID,Resposta,Data,QuestaoID,TuristaID,GuiaID")] RespostaAvaliacao respostaAvaliacao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RespostaID,Resposta,Data,QuestaoID,TuristaID,GuiaID")] RespostaAvaliacao respostaAvaliacao)
        {
