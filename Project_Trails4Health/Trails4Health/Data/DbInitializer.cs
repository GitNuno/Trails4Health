    ...
    public class DbInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            if (!context.Questoes.Any())
            {
                ...
                new Questao { NomeQuestao = "Classifique globalmente este trilho?", Desactivada = false, TipoResposta = "1 - Horrível | 5 - Excelente", ValorMaximo = 5, ValorMinimo = 1, NumeroOpcoes = 5},
                new Questao { NomeQuestao = "O trilho continha sinalização adequada?", Desactivada = false, TipoResposta = "Sim | Não", ValorMaximo = 5, ValorMinimo = 1, NumeroOpcoes = 2},
                new Questao { NomeQuestao = "Como classifica este trilho quanto ao grau de dificuldade?", Desactivada = false, TipoResposta = "1 - Muito Difícil | 5 - Muito Fácil", ValorMaximo = 5, ValorMinimo = 1, NumeroOpcoes = 5}
